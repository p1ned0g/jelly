...
public class App {
    public static void main(String[] args) {
        try (DiskManager disk = new DiskManager("mydb.db");){
            ...
            readBuf.get(data);
            System.out.println("Read from page: " + pageId + " : " + new String(data));
            
            int pageId2 = disk.allocate();
            ...
            readBuf2.get(data2);
            System.out.println("Read from page: " + pageId2 + " : " + new String(data2));
